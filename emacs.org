...
** MobileOrg
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq org-mobile-files (list "~/Dropbox/orgfiles/gtd.org"))
     (setq org-mobile-directory "~/Dropbox/orgfiles/mobile/")
     (setq org-mobile-inbox-for-pull "~/Dropbox/orgfiles/from_mobile.org")
   #+END_SRC
** Habits
  #+name: org-config
  #+BEGIN_SRC emacs-lisp
...
** Org agenda files
   #+name: org-config
   #+BEGIN_SRC emacs-lisp
(setq org-agenda-files (list "~/Dropbox/orgfiles/gtd.org"
...
** GTD
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     '(
      ("Todo" ?t "* TODO %^{Brief Description} %^g\n%?\nAdded: %U" "~/Dropbox/orgfiles/gtd.org" "Tasks")
      ))
   #+END_SRC
   ...
   #+BEGIN_SRC emacs-lisp
      (defun gtd ()
         (interactive)
         (find-file "~/Dropbox/orgfiles/gtd.org")
     )
